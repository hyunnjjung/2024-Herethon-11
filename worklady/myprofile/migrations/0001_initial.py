    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career', models.ManyToManyField(blank=True, null=True, to='myprofile.career', verbose_name='경력')),
                ('education', models.ManyToManyField(blank=True, null=True, to='myprofile.education', verbose_name='학력')),
            ],
        ),
    ]
